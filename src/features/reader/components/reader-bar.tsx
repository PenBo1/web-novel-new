...
export function ReaderBar({ children, position, theme }: ReaderBarProps) {
  return (
    <div
      className={cn(
...
export function ContentDisplay({ text, isFetching, primaryColor }: { text: string, isFetching: boolean, primaryColor: string }) {
  return (
