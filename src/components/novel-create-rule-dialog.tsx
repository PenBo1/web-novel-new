...
export function CreateRuleDialog({ onRuleCreate }: CreateRuleDialogProps) {
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={mode} onValueChange={(v) => setMode(v as "form" | "json")} className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="form">表单可视化编辑</TabsTrigger>
            <TabsTrigger value="json">JSON 源码编辑</TabsTrigger>
          </TabsList>

          <TabsContent value="form" className="space-y-6 py-4">
            {/* 基本信息 */}
            <div className="space-y-4 border-b border-gray-100 pb-6">
              <h3 className="font-semibold text-sm text-gray-900 border-l-2 border-primary pl-2">基本信息</h3>
              <div className="grid gap-4">
                <div>
                  <Label htmlFor="name" className="text-xs font-semibold text-gray-600">书源名称 *</Label>
                  <Input
                    id="name"
                    placeholder="如：香书小说"
                    value={formData.name || ""}
                ...
                <div>
                  <Label htmlFor="url" className="text-xs font-semibold text-gray-600">主页 URL *</Label>
                  <Input
                    id="url"
            ...
            {/* 搜索配置 */}
            <div className="space-y-4 border-b border-gray-100 pb-6">
              <h3 className="font-semibold text-sm text-gray-900 border-l-2 border-orange-500 pl-2">搜索提取配置</h3>
              <div className="grid gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                <div>
                  <Label htmlFor="search-url" className="text-xs font-semibold text-gray-600">搜索请求 API URL *</Label>
                  <Input
                    id="search-url"
                ...
                <div>
                  <Label htmlFor="search-method" className="text-xs font-semibold text-gray-600">HTTP 请求方法 *</Label>
                  <select
                    id="search-method"
                    value={formData.search?.method || "post"}
                    onChange={(e) => handleFormChange("search.method", e.target.value)}
                    className="w-full mt-1 px-3 py-2 border border-gray-200 rounded-md text-sm bg-white"
                  >
                ...
                <div>
                  <Label htmlFor="search-data" className="text-xs font-semibold text-gray-600">请求 Payload (表单字段)</Label>
                  <Input
                    id="search-data"
                ...
                <div>
                  <Label htmlFor="search-result" className="text-xs font-semibold text-gray-600">列表结果容器选择器 *</Label>
                  <Input
                    id="search-result"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="search-bookname" className="text-xs font-semibold text-gray-600">书名节点选择器 *</Label>
                    <Input
                      id="search-bookname"
                      placeholder=".title > a"
                  ...
                  <div>
                    <Label htmlFor="search-author" className="text-xs font-semibold text-gray-600">作者节点选择器 *</Label>
                    <Input
                      id="search-author"
                      placeholder=".author"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="search-latest" className="text-xs font-semibold text-gray-600">最新章节 (可选)</Label>
                    <Input
                      id="search-latest"
                  ...
                  <div>
                    <Label htmlFor="search-update" className="text-xs font-semibold text-gray-600">更新时间 (可选)</Label>
                    <Input
                      id="search-update"
            ...
            {/* 书籍详情页面 */}
            <div className="space-y-4 border-b border-gray-100 pb-6">
              <h3 className="font-semibold text-sm text-gray-900 border-l-2 border-emerald-500 pl-2">详情页提取配置</h3>
              <div className="grid gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="book-name" className="text-xs font-semibold text-gray-600">书名提取选择器 *</Label>
                    <Input
                      id="book-name"
                  ...
                  <div>
                    <Label htmlFor="book-author" className="text-xs font-semibold text-gray-600">作者提取选择器 *</Label>
                    <Input
                      id="book-author"
                ...
                <div>
                  <Label htmlFor="book-intro" className="text-xs font-semibold text-gray-600">书籍简介选择器 *</Label>
                  <Input
                    id="book-intro"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="book-category" className="text-xs font-semibold text-gray-600">书籍分类 (可选)</Label>
                    <Input
                      id="book-category"
                  ...
                  <div>
                    <Label htmlFor="book-cover" className="text-xs font-semibold text-gray-600">书籍封面图片 (可选)</Label>
                    <Input
                      id="book-cover"
            ...
            <div className="space-y-4">
              <h3 className="font-semibold text-sm text-gray-900 border-l-2 border-indigo-500 pl-2">目录与正文提取</h3>
              <div className="grid gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                <div>
                  <Label htmlFor="toc-url" className="text-xs font-semibold text-gray-600">独立目录页 URL (如果有)</Label>
                  <Input
                    id="toc-url"
                ...
                <div>
                  <Label htmlFor="toc-item" className="text-xs font-semibold text-gray-600">章节链接 &lt;a&gt; 选择器 *</Label>
                  <Input
                    id="toc-item"
                ...
                <div>
                  <Label htmlFor="chapter-title" className="text-xs font-semibold text-gray-600">正文页标题选择器 *</Label>
                  <Input
                    id="chapter-title"
                ...
                <div>
                  <Label htmlFor="chapter-content" className="text-xs font-semibold text-gray-600">正文页段落容器选择器 *</Label>
                  <Input
                    id="chapter-content"
                    placeholder="#content"
                ...
                <div>
                  <Label htmlFor="chapter-filter" className="text-xs font-semibold text-gray-600">垃圾文本清洗正则 (可选)</Label>
                  <Textarea
                    id="chapter-filter"
          ...
          <TabsContent value="json" className="space-y-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="json-content" className="text-xs font-semibold text-gray-600">
                JSON 数据结构
              </Label>
              <Textarea
                id="json-content"
  ...
  ...
                ...
                className="h-[400px] font-mono text-sm bg-gray-900 text-green-400 p-4 border-none border-t-4 border-t-primary rounded-xl"
              />
            </div>
          </TabsContent>
        </Tabs>
